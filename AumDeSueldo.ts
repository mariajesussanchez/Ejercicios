...
let salarioActual:number = rls.questionFloat("Ingrese su salario actual $: ");
    ...
    if (salarioActual <= 15000)
        {let salarioNuevo:number = (salarioActual * 1.20); 
        ...
        {let salarioNuevo:number = (salarioActual * 1.10); 
        ...
        {let salarioNuevo:number = (salarioActual * 1.05); 
        console.log("Ud recibio un aumento de salario de 5%, va a cobrar $: ", salarioNuevo);
}
    else {console.log("Usted cobrara $ ", salarioActual)};
